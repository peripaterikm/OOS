...
class TestIdeationModeComparisonAcceptance(unittest.TestCase):
    ...
    def test_active_roadmap_has_completed_5_2_and_not_regressed(self) -> None:
        ...
        self.assertRegex(roadmap, r"\*\*0\.2\.2\*\* Current item: \*\*(6\.1|6\.2|7\.1)\*\*")
        self.assertRegex(roadmap, r"\*\*0\.2\.4\*\* Completed from this roadmap: \*\*(10|11|12) / 16\*\*")
        self.assertRegex(roadmap, r"\*\*0\.2\.5\*\* Remaining: \*\*(6|5|4) / 16\*\*")
