...
- [x] **9.2** Smoke step passes on v2.14 fixtures with hardened gates (temp directory)
...
- [x] **9.12** One local commit made with message: `[v2.14] Fix controlled quality smoke review state`
