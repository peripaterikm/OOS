    ...
    profiles = [
        TopicProfile(
            ...
            query_templates={
                "pain_query": [
                    '"AI CFO" SMB pain',
                    '"cashflow" "small business" problem',
                    '"management reporting" finance pain',
                ],
                "workaround_query": [
                    '"SMB finance" spreadsheet workaround',
                    '"cashflow" manual spreadsheet',
                ],
                "buying_intent_query": [
                    '"AI CFO" pricing',
                    '"finance automation" "looking for"',
                ],
                "competitor_weakness_query": [
                    '"QuickBooks" "manual" "cashflow"',
                    '"accounting software" "spreadsheet"',
                ],
                "trend_trigger_query": [
